        ...
        <Navbar />
            ...
            <Container class="entry-content">
                ...
                <div class="static-inner">
                    ...
                    <p><strong>Keshav Industries</strong> is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, you can be assured that it will only be used in accordance with this privacy statement.</p>
                    <p><strong>Keshav Industries</strong> may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.</p>
                </div>
                ...
                <div class="static-inner">
                    <h3 class="hd3">What We Do With The Information We Gather</h3>
                    ...
                    <p>We are committed to ensuring that your information is secure. In order to prevent unauthorised access or disclosure, we have put in place suitable measures.</p>
                </div>

                <div class="static-inner">
                    <h3 class="hd3">How We Use Cookies</h3>
                ...
                <div class="static-inner">
                    <h3 class="hd3">Controlling Your Personal Information</h3>
