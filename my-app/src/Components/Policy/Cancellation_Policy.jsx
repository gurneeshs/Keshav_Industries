  ...
  return (
    <div className="">
      ...
      <Container>
        ...
        <h1 className='text-center mt-5 mb-4'>Shipping Policy</h1>
        <p>We always ship your order on the same day or within 24 hours of you placing it. Once shipped, you will receive an email with your shipment details. Under normal circumstances, your order will reach you within 7 working days.
          If you have any queries/concerns related to your shipment, please contact our support team care.customer@keshav.co.in within 24 hours of receiving the product/s.
        </p>
