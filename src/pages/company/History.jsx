...
const phases = [
  ...
  },
  {
    ...
    image: "../img/historyimg/image3.png",
...
const History = () => {
  return (
      <div className="relative mx-auto w-full px-4 py-8 md:px-8 lg:px-16">
        <div
        ...
        />
        <h2 className="text-4xl font-bold mb-10 text-center text-gray-900 relative z-10">Our History</h2>
        {phases.map((phase, index) => (
          <motion.div
            key={index}
            className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10 relative z-10"
