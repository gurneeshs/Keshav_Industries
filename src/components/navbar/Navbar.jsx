...
const Navbar = () => {
    ...
    return (
        <div className="px-5 bg-eda72f">
            {/* Contact Information */}
            <div className="flex flex-col md:flex-row justify-around items-center py-2 text-black text-xs md:text-sm space-y-2 md:space-y-0 md:space-x-6">
                <span className="flex items-center">
                    <h1 className="text-2xl font-bold">Keshav<br /> Industries</h1>
                </span>
