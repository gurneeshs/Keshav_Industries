  ...
  return (
    <div className="relative overflow-hidden">
      <div className="text-center my-8">
        ...
        <p className="text-lg text-gray-600">More than 8+ Trusted Certificates</p>
      </div>
      
      <div className="slider-wrapper flex">
        {/* Slider element with continuous scrolling */}
        <div
          className="slider flex space-x-8 animate-marquee"
          style={{
